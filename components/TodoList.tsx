...
const TodoList: React.FunctionComponent = () => {
    ...
    return (
        <div className='flex flex-col justify-center'>
            ...
            <div ref={infoRef}></div>
            {/* <div className='border border-green-600 mx-3 bg-green-200 rounded text-sm text-green-800 font-bold px-2 py-1 flex justify-center'>Task Added</div> */}
            {/* <div className='border border-red-600 mx-3 bg-red-200 rounded text-sm text-red-800 font-bold px-2 py-1 flex justify-center'>Task Deleted</div> */}
            {/* <div className='border border-yellow-600 mx-3 bg-yellow-200 rounded text-sm text-yellow-800 font-bold px-2 py-1 flex justify-center'>Task Updated</div> */}
